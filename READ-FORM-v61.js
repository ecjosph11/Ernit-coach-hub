...
- textMessage: the SAME recommendation compressed into a text message. Under 300 characters, 2\u20133 sentences. Start with the exact opener line. Name the program and its price. End with one simple ask (reply or grab 10 minutes). No subject line, no sign-off block, no line breaks, no emojis. It should read like Ernest typed it on his phone \u2014 warmer and shorter than the email, never a truncated copy of it.
- No emojis.`;
}
